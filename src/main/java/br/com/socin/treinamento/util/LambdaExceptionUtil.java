package br.com.socin.treinamento.util;
 ...
 * <p>
 * From <a href=
 * "http://stackoverflow.com/questions/27644361/how-can-i-throw-checked-exceptions-from-inside-java-8-streams">How
 * can I throw CHECKED exceptions from inside Java 8 streams?</a>. This class helps to handle
 * checked exceptions with lambdas. Example, with Class.forName method, which throws checked
 * exceptions:
 * </p>
 * 
 * <pre>
 * Stream.of("java.lang.Object", "java.lang.Integer", "java.lang.String")
 *     .map(rethrowFunction(Class::forName)).collect(Collectors.toList());
 * </pre>
 *
...
public final class LambdaExceptionUtil {
  ...
  /** uncheck(Class::forName, "xxx"); */
  public static <T, R, E extends Exception> R uncheck(Function_WithExceptions<T, R, E> function,
      T t) {
    try {
      return function.apply(t);
    } catch (Exception exception) {
